...
@Component({
  selector: 'app-friend-profile-posts',
  templateUrl: './friend-profile-posts.page.html',
  styleUrls: ['./friend-profile-posts.page.scss'],
})
export class FriendProfilePostsPage implements OnInit {
  ...
  async loadNextPage(event?: any) {
    ...
    try {
      ...
      setTimeout(() => {
        // Reset isLoading after a brief delay
        this.isLoading = false;
